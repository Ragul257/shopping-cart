      ...
      const addDiv = `
        <div class="wrapper">
          <div class="container-box">
            <span style="display:none;">${x.product}</span>
            <h2>${x.name}</h2>
            <img class="imgbox" src=${x.image} alt="product-image">
          </div>
          <div class="rupee">
...
function createNewItems(id,price,name, image,qty) {
  return `
    <div class="item-content">
      <div class="box-div">
        <div class="alignname">
          <img class="cart-img" src=${image} alt="product-image" />
          <div class="adject">
            <p class="bag">${name}</p>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">     
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="./img/slide/Home1.jpeg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="./img/slide/Home2.jpeg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="./img/slide/Home3.jpeg" class="d-block w-100" alt="...">
        </div>
      </div>
